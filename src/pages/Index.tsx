...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#03070b] flex flex-col overflow-x-hidden font-sans text-white z-0">
      ...
      {/* ─── EFECTO AURORA BOREAL (GPU OPTIMIZED) ─── */}
      ...
      {/* 3. MAPA DE MISIONES — VENEZUELA */}
      <div className="relative z-10">
        <VenezuelaMap />
      </div>

      {/* 4. MANIFIESTO Y MÉTRICAS */}
          ...
          <Link to="/acceso" className="group">
            ...
            >
              ...
              <div className="flex items-center gap-6 md:gap-8 w-full md:w-auto text-center md:text-left relative z-10">
                ...
                <div>
                  <h3 className="text-2xl md:text-3xl font-black italic text-[#50E8E3] tracking-tighter mb-2">LOGIN MINI APK</h3>
                  <p className="text-[10px] font-bold text-[#50E8E3]/60 uppercase tracking-widest">Acceso encriptado para runners y telemetría de carrera.</p>
                </div>
              </div>
